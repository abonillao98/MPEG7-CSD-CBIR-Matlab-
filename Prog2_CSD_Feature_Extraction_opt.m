clear all
% Feature extraction de 256 bins pero amb una conversió RGV a HMMD  vectorial i una funcio de cuantificació optimitzada
...
disp(['Hora inicio procesado optimizada ', num2str(num_images),' imagenes con ', num2str(hist_bins), ' bins: '   datestr(now, 'dd/mm/yy-HH:MM')]);
tic
...
toc
disp(['Hora finalizacion procesado opt ', num2str(num_images),' imagenes con ', num2str(hist_bins), ' bins: '   datestr(now, 'dd/mm/yy-HH:MM')]);
